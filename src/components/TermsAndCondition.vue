<template>
    <v-dialog v-model="dialog" :width="isMobile ? '90%' : '50%'">
        <template v-slot:activator="{ on }">
            <v-btn text small class="button-color" v-on="on" v-t="'termsAndCond.button'" />
        </template>
        <v-card>
            <v-card-title>
                <span class="headline">{{ $t('termsAndCond.header') }}} Neighbour care</span>
            </v-card-title>
            <v-card-text>
                <p>These terms and conditions outline the rules and regulations for the use of Dominik Grafik
                    Development's Website.</p> <br/>
                <span style="text-transform: capitalize;"> Dominik Grafik Development</span> is located at:<br/>
                <address>Główna 6 Wrocław <br/>55-114 - Dolnyśląsk , Poland<br/>
                </address>
                <p>By accessing this website we assume you accept these terms and conditions in full. Do not continue to
                    use Dominik Grafik Development's website
                ...
                <p>The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer
                    ...
                    prevailing law
                    of Poland. Any use of the above terminology or other words in the singular, plural,
                    capitalisation and/or he/she or they, are taken as interchangeable and therefore as referring to
                    same.</p>
                <h3>Cookies</h3>
                <p>We employ the use of cookies. By using Dominik Grafik Development's website you consent to the use of
                    cookies
                    in accordance with Dominik Grafik Development's privacy policy.</p>
                ...
                <h3>License</h3>
                <p>Unless otherwise stated, Dominik Grafik Development and/or it's licensors own the intellectual
                    property rights for
                    all material on Dominik Grafik Development. All intellectual property rights are reserved. You may
                    view and/or print
                    pages from https://neighbourcare.com for your own personal use subject to restrictions set in these
                    terms and conditions.</p>
                <p>You must not:</p>
                <ol>
                    <li>Republish material from https://neighbourcare.com</li>
                    <li>Sell, rent or sub-license material from https://neighbourcare.com</li>
                    <li>Reproduce, duplicate or copy material from https://neighbourcare.com</li>
                </ol>
                <p>Redistribute content from Dominik Grafik Development (unless content is specifically made for
                    redistribution).</p>
                ...
                <p>We will approve link requests from these organizations if we determine that: (a) the link would not
                    ...
                    allowed
                    to link); (b)the organization does not have an unsatisfactory record with us; (c) the benefit to us
                    from
                    the visibility associated with the hyperlink outweighs the absence of Dominik Grafik Development;
                    and (d) where the
                ...
                <p>If you are among the organizations listed in paragraph 2 above and are interested in linking to our
                    website,
                    you must notify us by sending an e-mail to <a href="mailto:dominik.grafik@gmail.com"
                                                                  title="send an email to dominik.grafik@gmail.com">dominik.grafik@gmail.com</a>.
                ...
                <p>No use of Dominik Grafik Development's logo or other artwork will be allowed for linking absent a
                    trademark license
                    agreement.</p>
                <h3>Iframes</h3>
