<template>
  ...
  >
    ...
    <v-card>
      ...
      <v-card-text>
        <p>
          These terms and conditions outline the rules and regulations for the use of Dominik Grafik
          Development's Website.
        </p> <br>
        <span style="text-transform: capitalize;"> Dominik Grafik Development</span> is located at:<br>
        <address>
          Główna 6 Wrocław <br>55-114 - Dolnyśląsk , Poland<br>
        </address>
        <p>
        ...
        <h3>Cookies</h3>
        <p>
          We employ the use of cookies. By using Dominik Grafik Development's website you consent to the use of
          cookies
          in accordance with Dominik Grafik Development's privacy policy.
        </p>
        <p>
        ...
        <h3>License</h3>
        <p>
          Unless otherwise stated, Dominik Grafik Development and/or it's licensors own the intellectual
          property rights for
        ...
        <p>
          Redistribute content from Dominik Grafik Development (unless content is specifically made for
          redistribution).
        </p>
        ...
        <p>
          ...
          you must notify us by sending an e-mail to <a
            href="mailto:dominik.grafik@gmail.com"
            title="send an email to dominik.grafik@gmail.com"
          >dominik.grafik@gmail.com</a>.
        ...
        <p>
          No use of Dominik Grafik Development's logo or other artwork will be allowed for linking absent a
          trademark license
          agreement.
        </p>
        <h3>Iframes</h3>
