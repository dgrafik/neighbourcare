<template>
    <div class="acc-info__div--main-container">
        <div class="acc-info__div">
            <h2 class="acc-info__h2" v-t="'settings.header'"/>
            <v-form v-model="valid" class="acc-info__form" ref="form">
                <v-card class="acc-info__card">
                    <v-card-title class="acc-info__h3" v-t="'settings.generalInf'"/>
                    <v-card-text>
                        <v-text-field
                        ...
                        ></v-autocomplete>
                        <v-tooltip left v-if="canNotGeoLocateUser" max-width="90%">
                ...
                <v-card class="acc-info__card">
                    <v-card-title class="acc-info__h3" v-t="'settings.addressInf'"/>
                    <v-card-text>
                        <p>
                ...
                <div v-if="false">
                    <h3 class="acc-info__h3">Social media</h3>
                    <v-text-field
                ...
                <v-card class="acc-info__card">
                    <v-card-title class="acc-info__h3" v-t="'settings.changePass'"/>
                    <v-card-text>
                        <v-text-field
    ...
    export default {
        ...
        mounted() {
            if (!this.userInformation.generalInfo || !this.userInformation.address || !this.userInformation.socialMedia && !this.userInformation.coordinates) {
                ...
                const {generalInfo, address, socialMedia, location} = JSON.parse(localStorage.getItem('nh-user-information'))
            ...
            if (this.isLocalizationEmpty && this.isAddressEmpty)
                this.generalInfo.activeUser = false
        },
        computed: {
        ...
        methods: {
            ...
            async save() {
                ...
                if ((this.newLocation.lat && this.newLocation.lng) &&
                    ...
                    await this.setToFirestore(this.lat, this.lng)
